...
execute if entity @p[distance=..15,scores={PZTaktG.6Wert=1}] run data merge entity @n[type=minecraft:marker,tag=EtiTaktG.6Bool] {CustomName:{bold:true,color:"green",text:"wahr"} }
...
execute if entity @p[distance=..15,scores={PZTaktG.6Wert=2}] run data merge entity @n[type=minecraft:marker,tag=EtiTaktG.6Bool] {CustomName:{bold:true,color:"red",text:"falsch"} }
...
execute if entity @n[type=minecraft:marker,tag=EtiTaktG.6Bool] as @a[distance=..25] unless entity @s[scores={PZTaktG.6Wert=0}] run tellraw @s ["Taktgeber.6:\n",{text:"bool = ",bold:true},{text:"wahr",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Wert wahr"} },click_event:{action:"run_command",command:"/trigger PZTaktG.6Wert set 1"} },"\n",{text:"bool = ",bold:true},{text:"falsch",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Wert falsch"} },click_event:{action:"run_command",command:"/trigger PZTaktG.6Wert set 2"} },"\n",{text:"bool == ",bold:true},{entity:"@n[type=minecraft:marker,tag=EtiTaktG.6Bool]",nbt:"CustomName",interpret:true},"\n",{text:"solange(bool) takt(20,3)",color:"gray",bold:true} ]
