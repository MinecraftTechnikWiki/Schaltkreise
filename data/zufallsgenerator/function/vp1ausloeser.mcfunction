...
tellraw @s ["Zufallsgenerator.erweitert.1:\n",{text:"Felder == [",bold:true},{storage:"zufallsgenerator:vp1daten",nbt:'"EigZufG.p1Felder"[]',color:"dark_purple",bold:true},{text:"]",bold:true},"\n",{text:"Felder.laenge (",bold:true},{text:"=laenge + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Länge + 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.p1Wert set 1"} },{text:",",bold:true},{text:"=laenge - 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Länge - 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.p1Wert set -1"} },{text:") == ",bold:true},{score:{name:"VarZufG.p1Laenge",objective:"PZZufG.p1Wert"},color:"gold",bold:true},"\n",{text:"Felder.position = ",bold:true},{text:"zufallswert(0,laenge-1)",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für eine zufällige Position"} },click_event:{action:"run_command",command:"/trigger PZZufG.p1Wert set 2"} },"\n",{text:"Felder.position == ",bold:true},{score:{name:"@s",objective:"PZZufG.p1Pos"},color:"green",bold:true},"\n",{text:"Felder[",bold:true},{score:{name:"@s",objective:"PZZufG.p1Pos"},color:"green",bold:true},{text:"] == ",bold:true},{score:{name:"VarZufG.p1Wert",objective:"PZZufG.p1Pos"},color:"dark_purple",bold:true}]
