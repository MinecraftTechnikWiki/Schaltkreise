...
execute if entity @p[distance=..15,scores={PZZufG.4Wert=-1}] run scoreboard players remove VarZufG.4Min PZZufG.4Wert 1
...
# Die Zufallszahl wird in dem größt möglichen Zahlenbereich erzeugt, damit sie in nachfolgenden Befehlen leicht zurecht gestutzt werden kann.
execute if entity @p[distance=..15,scores={PZZufG.4Wert=3}] run random value 0..2147483646 zufallsgenerator:v4zufall

# Damit die Zufallszahl in dem eingestellten Zahlenbereich liegt, wird zuerst die Zufallszahl modulo der Bereichs-Variable gerechnet und anschließend wird die Min-Variable darauf addiert. Falls die Min- und Max-Variable gleich sind, wird der Zufallswert auf den Wert der Min-Variable gesetzt.
...
execute if score VarZufG.4Bereich PZZufG.4Wert matches 0.. as @a[distance=..15] unless entity @s[scores={PZZufG.4Wert=0}] run tellraw @s ["Zufallsgenerator.4:\n",{text:"min (",bold:true},{text:"=min + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Minimum + 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.4Wert set 1"} },{text:",",bold:true},{text:"=min - 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Minimum - 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.4Wert set -1"} },{text:") == ",bold:true},{score:{name:"VarZufG.4Min",objective:"PZZufG.4Wert"},color:"dark_purple",bold:true},"\n",{text:"max (",bold:true},{text:"=max + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Maximum + 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.4Wert set 2"} },{text:",",bold:true},{text:"=max - 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Maximum - 1"} },click_event:{action:"run_command",command:"/trigger PZZufG.4Wert set -2"} },{text:") == ",bold:true},{score:{name:"VarZufG.4Max",objective:"PZZufG.4Wert"},color:"dark_purple",bold:true},"\n",{text:"var = ",bold:true},{text:"zufallswert(min,max-1)",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für einen Zufallswert"} },click_event:{action:"run_command",command:"/trigger PZZufG.4Wert set 3"} },"\n",{text:"var == ",bold:true},{score:{name:"VarZufG.4Zufallswert",objective:"PZZufG.4Wert"},color:"dark_purple",bold:true}]
